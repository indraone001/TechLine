        ...
        <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-6 d-none d-lg-block">
                    <img style="margin-top : 30%; margin-left : 5%;" class="text-center" width="100%" src="<?= base_url('assets/'); ?>img/login.png" alt="">
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/register') ?>">
                            <div class="form-group">
                                <input type="username" class="form-control form-control-user" id="username" name="username" placeholder="Full name" value="<?= set_value('username'); ?>">
